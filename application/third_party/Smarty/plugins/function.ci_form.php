...
function smarty_function_ci_form( $params, &$smarty )
{
    ...
    $data['value'] = isset( $params['value'] ) ? $params['value'] : '';
    
    if ($params['type'] != 'hidden')
    {
        $data['id']    = isset( $params['id'] ) ? $params['id'] : '';
        $data['style'] = isset( $params['style'] ) ? $params['style'] : '';
    }
    ...
    switch ( $params['type'] )
    {
        ...
        case 'textarea':
            ...
            {
                $data['type'] = 'textarea';
                $data['rows'] = isset( $params['rows'] ) ? $params['rows'] : '';
                $data['cols'] = isset( $params['cols'] ) ? $params['cols'] : '';
            }
            
            if ( $params['type'] != 'textarea' )
            {
                $data['maxlength'] = isset( $params['maxlength'] ) ? $params['maxlength'] : '';
