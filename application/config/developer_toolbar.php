...
*/
$config['debug_mode'] = ENVIRONMENT != 'production';
...
| Stylesheet files.
*/
$config['developer_toolbar_stylesheet_folder'] = 'themes/css/developer_toolbar/';
...
| javascript files.
*/
$config['developer_toolbar_javascript_folder'] = 'themes/js/developer_toolbar/';
