...
$config['use_recaptcha'] = (ENVIRONMENT == 'development') ? FALSE : TRUE;

$config['recaptcha_public_key'] = '6Lfk58ISAAAAALaRMyZ8lyfDNs6Rax89QXm9A65T';
$config['recaptcha_private_key'] = '6Lfk58ISAAAAAIOFw_Xm_vuItN8NCQtBW7Sbwhgg';
