{include file='overall_header.tpl'}
  ...
  <div id="articleblock">
    <div id="article-container-one">
      <div class="articles">
        <div class="article-icon"><img src="themes/images/users.png" width="80" height="80"></div>
    ...
    <div id="article-container-two">
      <div class="articles">
        <div class="article-icon"><img src="themes/images/pen.png" width="80" height="80"></div>
        <div class="article-div">
    ...
    <div id="article-container-three">
      <div class="articles">
        <div class="article-icon"><img src="themes/images/bookopen.png" width="80" height="80"></div>
        <div class="article-div">
