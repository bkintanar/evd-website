{include file='overall_header.tpl'}
      ...
      <div class="panel">
 	    <div class="container">
          <div class="wt-rotator">
            <div class="screen">
              <noscript><img src="{ci_config name='base_url'}themes/images/tmp/1.jpg"/></noscript>
            </div>
            <div class="c-panel">
              <div class="buttons">
            ...
            <ul>
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/1.jpg" title="3D abstract art"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/1.jpg"/></a>
                ...
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/2.jpg" title="san francisco"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/2.jpg"/></a>
                  <a href="#" target="_blank"></a>
                ...
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/3.jpg" title="3D abstract art"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/3.jpg"/></a>   
                  <a href="#" target="_blank"></a>
                  <div style="left:5px; top:36px; width:336px; height:0; color:#000; background-color:#FFF">
                    <h1 style="color:#0CF">Cambinocot Church Anniversary</h1>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                ...
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/4.jpg" title="rainbow bridge"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/4.jpg"/></a>                  
                  <a href="#" target="_blank"></a>
                ...
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/5.jpg" title="lion"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/5.jpg"/></a>        
                  <a href="#" target="_blank"></a>
                  <div style="left:5px; top:94px; width:336px; height:0;"> 
                    <h1>OMSIFY: Voice of Triumph Concert</h1>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                ...
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/6.jpg" title="highway"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/6.jpg"/></a>                    
                  <a href="#" target="_blank"></a>
                ...
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/7.jpg" title="hong kong"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/7.jpg"/></a>                    
                  <a href="#" target="_blank"></a>
                  <div style="left:5px; top:36px; width:350px; height:0;"> 
                    <h1>TFC 5th Church Anniversary</h1>
                    Lorem ipsum ad vis puto molestie, ex est simul docendi, ei ius decore patrioque complectitur. 
                ...
                <li>
                  <a href="{ci_config name='base_url'}themes/images/tmp/8.jpg" title="aquarium"><img src="slir/w45-h45-c1:1-q100/{ci_config name='base_url'}themes/images/tmp/8.jpg"/></a>                    
                  <a href="#" target="_blank"></a>
  ...
  <!--Articles-->
  <div id="articleblock">
    <div id="article-container-one">
      <div class="articles">
        <div class="article-icon"><img src="{ci_config name='base_url'}themes/images/users.png" width="80" height="80"></div>
    ...
    <div id="article-container-two">
      <div class="articles">
        <div class="article-icon"><img src="{ci_config name='base_url'}themes/images/pen.png" width="80" height="80"></div>
        <div class="article-div">
          <div class="article-title">District Presbyter's Desk</div>
          <div class="article-contents">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in.
          </div>
        </div>  
      </div>
    </div>
    
    <div id="article-container-three">
      <div class="articles">
        <div class="article-icon"><img src="{ci_config name='base_url'}themes/images/bookopen.png" width="80" height="80"></div>
        <div class="article-div">
          <div class="article-title">News and Updates</div>
          <div class="article-contents">In voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur occaecat cupidatat non proident, in culpas officia deserunt.
          </div>
        </div>  
      </div>
    </div>
  ...
  <div class="container-main-blog">  
    <div class="main-blog">
     <h2>A Call <em>to</em> Build: Doing Church <em>in the</em> 21st Century</h2>
      ...
      <div class="main-blog-icon"><img src="{ci_config name='base_url'}themes/images/blogbig.png" width="185" height="125"></div>
  ...
  <br /><br />
   <div class="small-blog-container">
    <div class="small-blog-left"> 
      <div class="small-blog-icon"><img src="{ci_config name='base_url'}themes/images/blogsmall.png"></div>
    ...
    <div class="small-blog-right"> 
      <div class="small-blog-icon"><img src="{ci_config name='base_url'}themes/images/blogsmall1.png"></div>
      <div class="small-blog-title">
